...
describe('Template', function () {
  ...
  describe('Variable Replacement', function () {
    // basic-content
    it('should replace a variable within the content of a entity', function () {
      return compare({name: 'Barry'}, 'test/um/basic-content/source.um', 'test/um/basic-content/expected-1.um')
    })

    it('should replace a variable within the content of a entity with another value', function () {
      return compare({name: 'Bob'}, 'test/um/basic-content/source.um', 'test/um/basic-content/expected-2.um')
    })

    // basic-params
    it('should replace a variable within the params of a entity', function () {
      return compare({name: 'Barry'}, 'test/um/basic-params/source.um', 'test/um/basic-params/expected-1.um')
    })

    it('should replace a variable within the params of a entity with another value', function () {
      return compare({name: 'Bob'}, 'test/um/basic-params/source.um', 'test/um/basic-params/expected-2.um')
    })

    // multi-content
    it('should replace multiple variable with the in the content of a entity', function () {
      return compare({name: 'Barry', named: 'Bob'}, 'test/um/multi-content/source.um', 'test/um/multi-content/expected-1.um')
    })

    it('should replace muleiplt variable with the in the content of a entity with another value', function () {
      return compare({name: 'Bob'}, 'test/um/multi-content/source.um', 'test/um/multi-content/expected-2.um')
    })

    it('should replace multiple variable with the in the content of a entity with another value', function () {
      return compare({named: 'Bob'}, 'test/um/multi-content/source.um', 'test/um/multi-content/expected-3.um')
    })

    // multi-params
    it('should replace multiple variables with the in the params of a entity', function () {
      return compare({name: 'Barry', named: 'Bob'}, 'test/um/multi-params/source.um', 'test/um/multi-params/expected-1.um')
    })

    it('should replace multiple variables with the in the params of a entity with another value', function () {
    ...
    // deep-variable
    it('should replace a variable with the in the content of a entity', function () {
      return compare({person: {name: { first: 'Barry'}}}, 'test/um/deep-variable/source.um', 'test/um/deep-variable/expected-1.um')
    })

    it('should replace a variable with the in the content of a entity with another value', function () {
  ...
  describe('If Statements', function () {
    it('should handle if with no content', function () {
  ...
  describe('Ifnot Statements', function () {
    it('should handle ifnot with no content', function () {
