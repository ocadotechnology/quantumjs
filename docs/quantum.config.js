...
const typeLinks = {
  ...
  File: baseUrl + '/docs/modules/quantum-core/#file',
  FileInfo: baseUrl + '/docs/modules/quantum-core/#fileinfo',
  Selection: baseUrl + '/docs/modules/quantum-core/#selection',
  Watcher: baseUrl + '/docs/modules/quantum-core/#watcher',
